...
Limitations
Shopify supports a maximum of 3 product options and 100 variants per product.
Since the product already uses Shape, Print Type, and Material as variant options, Premium Finishing could not be added as a native variant.
Therefore, Premium Finishing has been implemented as a configurable custom option with price adjustments.
